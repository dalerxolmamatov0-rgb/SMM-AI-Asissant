...
const translations = {
  uz: {
    ...
    feat_5_title: "Interaktiv AI SMM Maslahatchi Chat",
    feat_5_desc: "Har qanday savolingizga javob beruvchi va kontent strategiyangizni tahlil qiluvchi aqlli yordamchi.",
    feat_6_title: "Tezkor Eksport & Boshqaruv",
    feat_6_desc: "Yaratilgan kontentlarni bitta tugma orqali nusxalash, Telegramga yuborish yoki Excel / Word / PDF ga yuklash.",

    // Pricing
    pricing_title: "Hamyonbop va Shaffof Tariflar",
    pricing_desc: "O'zingizga mos tarifni tanlang va chegaralardan xoli bo'ling",
    plan_free_name: "Bepul Boshlang'ich",
    plan_free_price: "0 so'm",
    plan_free_period: "/ oyiga",
    plan_free_f1: "Oyiga 10 ta AI generatsiya",
    plan_free_f2: "Barcha 5 ta generator vositalari",
    plan_free_f3: "AI Chat Maslahatchi",
    plan_free_f4: "Cheklangan tezlik",
    plan_free_btn: "Hozir Boshlash",

    plan_pro_name: "Pro 50",
    plan_pro_price: "50 000 so'm",
    plan_pro_period: "/ oyiga",
    plan_pro_f1: "Oyiga 50 ta to'liq AI generatsiya",
    plan_pro_f2: "Barcha vositalardan to'liq foydalanish",
    plan_pro_f3: "Yuqori tezlik va ustuvor navbat",
    plan_pro_f4: "Telegram orqali 24/7 qo'llab-quvvatlash",
    plan_pro_btn: "Pro 50 ga Ulanish ⚡",

    plan_unlimited_name: "Cheksiz VIP",
    plan_unlimited_price: "120 000 so'm",
    plan_unlimited_period: "/ oyiga",
    plan_unlimited_f1: "Cheksiz AI generatsiyalar",
    plan_unlimited_f2: "Eng yuqori VIP tezlik va Gemini Pro",
    plan_unlimited_f3: "Eksklyuziv marketing shablonlari",
    plan_unlimited_f4: "Shaxsiy menejer va to'liq yordam",
    plan_unlimited_btn: "VIP Cheksiz Olish 👑",

    // Dashboard Tools
    tab_generator: "AI Generator",
    tab_chat: "AI Maslahatchi",
    tab_calendar: "Kontent Reja",
    tab_history: "Tarix",
    tab_profile: "Profil & Tarif",

    tool_post: "SMM Post",
    tool_reels: "Reels Ssenariy",
    tool_plan: "Kontent Reja",
    tool_ads: "Reklama Matni",
    tool_strategy: "Strategiya",

    topic_label: "Mavzu yoki mahsulot / xizmat haqida yozing:",
    topic_placeholder: "Masalan: Erkaklar kiyimlari do'koni uchun yangi kuzgi kolleksiya e'loni...",
    tone_label: "Matn ohangi (Tone of voice):",
    tone_friendly: "Do'stona va samimiy",
    tone_professional: "Professional va jiddiy",
    tone_sales: "Sotuvga undovchi va jozibador",
    tone_humorous: "Hazilomuz va yengil",
    tone_luxury: "Premium va elita",
    lang_output_label: "Chiqish tili:",
    btn_generate: "AI Yordamida Yaratish 🚀",
    btn_generating: "AI kontent yaratmoqda... ⏳",
    ...
    feedback_placeholder: "Taklifingiz yoki fikringizni batafsil yozing...",
  ...
  en: {
    ...
    features_desc: "All the essential social media content types in one place",
    ...
    feat_5_title: "Interactive AI SMM Advisor Chat",
    feat_5_desc: "Smart assistant ready 24/7 to answer your social media questions and refine your strategy.",
    feat_6_title: "Instant Export & Management",
    feat_6_desc: "One-click copy, send to Telegram, or export directly into Excel, Word, or PDF.",

    // Pricing
    pricing_title: "Affordable & Transparent Pricing",
    pricing_desc: "Choose the perfect plan and unleash unlimited AI potential",
    plan_free_name: "Free Starter",
    plan_free_price: "$0",
    plan_free_period: "/ month",
    plan_free_f1: "10 AI generations per month",
    plan_free_f2: "All 5 core generator tools",
    plan_free_f3: "AI Chat Advisor",
    plan_free_f4: "Standard speed",
    plan_free_btn: "Start Free Now",

    plan_pro_name: "Pro 50",
    plan_pro_price: "50,000 UZS",
    plan_pro_period: "/ month",
    plan_pro_f1: "50 full AI generations per month",
    plan_pro_f2: "Full access to all tools",
    plan_pro_f3: "High-speed priority queue",
    plan_pro_f4: "24/7 priority Telegram support",
    plan_pro_btn: "Upgrade to Pro 50 ⚡",

    plan_unlimited_name: "VIP Unlimited",
    plan_unlimited_price: "120,000 UZS",
    plan_unlimited_period: "/ month",
    plan_unlimited_f1: "Unlimited AI generations",
    plan_unlimited_f2: "Fastest VIP speed & Gemini Pro",
    plan_unlimited_f3: "Exclusive marketing templates",
    plan_unlimited_f4: "Dedicated personal support",
    plan_unlimited_btn: "Get Unlimited VIP 👑",

    // Dashboard Tools
    tab_generator: "AI Generator",
    tab_chat: "AI Advisor",
    tab_calendar: "Content Plan",
    tab_history: "History",
    tab_profile: "Profile & Plan",

    tool_post: "SMM Post",
    tool_reels: "Reels Script",
    tool_plan: "Content Plan",
    tool_ads: "Ad Copy",
    tool_strategy: "Strategy",

    topic_label: "Describe your topic or product / service:",
    topic_placeholder: "E.g., Launch announcement for new men's autumn clothing collection...",
    tone_label: "Tone of voice:",
    tone_friendly: "Friendly and engaging",
    tone_professional: "Professional and authoritative",
    tone_sales: "Persuasive and sales-driven",
    tone_humorous: "Humorous and witty",
    tone_luxury: "Premium and luxury",
    lang_output_label: "Output language:",
    btn_generate: "Generate with AI 🚀",
    btn_generating: "AI is creating your content... ⏳",
    ...
    feedback_sub: "Your message goes directly to the admin on Telegram",
    feedback_placeholder: "Write your feedback or idea in detail...",
  ...
  ru: {
    ...
    feat_5_title: "Интерактивный AI SMM Консультант",
    feat_5_desc: "Умный чат-помощник для анализа стратегии и ответов на любые вопросы по продвижению.",
    feat_6_title: "Быстрый экспорт и управление",
    feat_6_desc: "Копирование в 1 клик, отправка в Telegram или выгрузка в Excel, Word и PDF.",

    // Pricing
    pricing_title: "Доступные и прозрачные тарифы",
    pricing_desc: "Выберите подходящий тариф и создавайте без ограничений",
    plan_free_name: "Бесплатный Старт",
    plan_free_price: "0 сум",
    plan_free_period: "/ в месяц",
    plan_free_f1: "10 AI генераций каждый месяц",
    plan_free_f2: "Все 5 инструментов генерации",
    plan_free_f3: "AI Чат Консультант",
    plan_free_f4: "Стандартная скорость",
    plan_free_btn: "Начать сейчас",

    plan_pro_name: "Pro 50",
    plan_pro_price: "50 000 сум",
    plan_pro_period: "/ в месяц",
    plan_pro_f1: "50 полных AI генераций в месяц",
    plan_pro_f2: "Полный доступ ко всем инструментам",
    plan_pro_f3: "Высокая скорость и приоритет",
    plan_pro_f4: "Поддержка в Telegram 24/7",
    plan_pro_btn: "Подключить Pro 50 ⚡",

    plan_unlimited_name: "Безлимитный VIP",
    plan_unlimited_price: "120 000 сум",
    plan_unlimited_period: "/ в месяц",
    plan_unlimited_f1: "Безлимитные AI генерации",
    plan_unlimited_f2: "Максимальная скорость и Gemini Pro",
    plan_unlimited_f3: "Эксклюзивные шаблоны и маркетинг",
    plan_unlimited_f4: "Персональная поддержка",
    plan_unlimited_btn: "Получить VIP Безлимит 👑",

    // Dashboard Tools
    tab_generator: "AI Генератор",
    tab_chat: "AI Консультант",
    tab_calendar: "Контент-план",
    tab_history: "История",
    tab_profile: "Профиль и Тариф",

    tool_post: "SMM Пост",
    tool_reels: "Reels Сценарий",
    tool_plan: "Контент-план",
    tool_ads: "Рекламный Текст",
    tool_strategy: "Стратегия",

    topic_label: "Опишите тему, товар или услугу:",
    topic_placeholder: "Например: Анонс новой осенней коллекции мужской одежды...",
    tone_label: "Тональность текста (Tone of voice):",
    tone_friendly: "Дружелюбный и открытый",
    tone_professional: "Профессиональный и экспертный",
    tone_sales: "Продающий и убедительный",
    tone_humorous: "С юмором и легкий",
    tone_luxury: "Премиальный и элитный",
    lang_output_label: "Язык генерации:",
    btn_generate: "Сгенерировать с AI 🚀",
    btn_generating: "AI создает контент... ⏳",
    ...
    feedback_placeholder: "Напишите ваш отзыв или предложение подробно...",
